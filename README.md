...
- **GitHub Issues**: [Сообщить о проблеме](https://github.com/NexDjen/Lawyer/issues)
- **Email**: Для вопросов и предложений

## 🙏 Благодарности

- WindexAI за предоставление мощного ИИ API
- OpenAI за SDK совместимости
...
- [📖 Подробная документация](README_DETAILED.md)
- [⚙️ Руководство по настройке](SETUP.md)
- [📋 История изменений](CHANGELOG.md)
- [🛠️ Руководство по рефакторингу](REFACTORING_GUIDE.md)

---

**🚀 Готовы начать? Следуйте инструкциям в разделе "Быстрый старт"!**